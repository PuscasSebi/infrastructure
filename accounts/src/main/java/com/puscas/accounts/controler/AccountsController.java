...
import static com.puscas.accounts.constants.AccountsConstants.MESSAGE_200;
import static com.puscas.accounts.constants.AccountsConstants.STATUS_200;

@Tag(
        name = "CRUD REST APIs for Accounts in puscas",
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "get build info that is deployed into account microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<CustomerDto> fetchAccountDetails(@RequestParam
                                                                   // @Pattern(regexp = "(^$[0-9]{10})", message = "Mobile number must be 10 digitsw")
                                                                   String mobileNumber) {
